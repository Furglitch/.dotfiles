...
echo ''
echo 'Opening Stylus extension page and close window...'
...
echo ''
echo 'Opening Firefox Color theme page and close window...'
echo "Waiting for user to install Firefox Color theme..."
...
echo ''
echo "Opening Stylus extension page and close window..."
echo "Waiting for user to install Stylus extension..."
